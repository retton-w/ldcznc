...
public:
        ...
        bool CheckJPGFileHash(char *szFileName);
        bool CheckBufferHash(char *inBuffer,unsigned long ulBufferSize);
        bool CreateJPGFileHash(char *szFileName);
        bool CreateJPGBufferHash(unsigned char* ppJpgBuffer,unsigned long* pJpgSize);//Daniel Cao 2009-11-19
